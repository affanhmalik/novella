...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'lms_userprofile', (
            ...
            ('closed', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
        ))
        db.send_create_signal(u'lms', ['UserProfile'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table(u'lms_userprofile')
    ...
    models = {
        ...
        u'lms.userprofile': {
            ...
            'closed': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
